...
if (engbtn !== null) {
  engbtn.addEventListener("click", function (e) {
    ...
    window.open("Training-Program-Registration-Website/English.html", "_self");
  });
}
...
if (techbtn !== null) {
  techbtn.addEventListener("click", function (e) {
    console.log(sessionStorage.getItem("index"));
    window.open("Training-Program-Registration-Website/technical.html", "_self");
  });
}
...
if (infbtn !== null) {
  infbtn.addEventListener("click", function () {
    console.log("hee");
    window.open("Training-Program-Registration-Website/Info.Html"), "_self";
  });
}
